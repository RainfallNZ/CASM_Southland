...
OutputBaseFileName <- "SCAMP-InputsV3bTest"
if (Scenario == "Default"){
...
CASMnzsegOverrideFile   <- file.path(DataDirectory,"CASMnzsegmentOverideForLocationV2.csv")
...
setColWidths(Out,sheet = "Wetland Inputs",cols =c(1,2,16),widths = 'auto')
addStyle(Out,sheet = "Wetland Inputs",cols=3:16,rows=3,style=hs2)
addStyle(Out,sheet = "Wetland Inputs",cols=4,rows=2,style=subheadingstyle1)
addStyle(Out,sheet = "Wetland Inputs",cols=3:16,rows=4:(nrow(WetlandData)+3),gridExpand = TRUE, style=OnsSD)
}
