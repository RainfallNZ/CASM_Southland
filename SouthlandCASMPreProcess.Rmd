...
OutputBaseFileName <- "SCAMP-InputsV3fTest"
if (Scenario == "Default"){
...
LeachRateRasterFile     <- file.path(GISDataDirectory,"LeachRateRasterV3 250 x 250.tif") #upgraded after provision of Version 3 look up table
#PredictorRasterFile     <- file.path(GISDataDirectory,"PredictorRaster 250 x 250.tif")
PredictorRasterFile     <- file.path(GISDataDirectory,"PredictorRasterV3 250 x 250.tif") #upgraded after provision of Version 3 look up table
...
if (Scenario == "Default") {
  ...
  #**********************************************************
  # This can also be used if the lesach rate raster file is missing or needs to be re-created
