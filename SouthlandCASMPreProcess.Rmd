...
OutputBaseFileName <- "SCAMP-InputsV4fTest"
if (Scenario == "Default"){
...
LeachRateLUTFile        <- file.path(DataDirectory,"Losses Lookup Table V4.xlsx")     #Updated 23rd August 2023 from "Loss Lookup Table - Updated March 2022.xlsx" provided by Ewen
...
if (Scenario %in% c("Wetland1","Wetland3")){
...
```{r, eval = FALSE}
bob <- LoadComparer(c(file.path(DataDirectory,"SCAMP-InputsV3b.xlsx"),OutputFileName))
sum(bob$AbsDiff)
