...
LeachRateRaster <- stack(file.path(GISDataDirectory,LeachRateRasterFile))
...
Plot a histogram showing percentage of segments (for strahler order 3 and above) are in 10 bins of % upstream exotic grassland
