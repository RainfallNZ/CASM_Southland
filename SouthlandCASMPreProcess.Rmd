...
OutputBaseFileName <- "SCAMP-InputsV4Test"
if (Scenario == "Default"){
...
LeachRateRasterFile     <- file.path(GISDataDirectory,"LeachRateRasterV4 250 x 250.tif") #upgraded after provision of Version 4 look up table
#PredictorRasterFile     <- file.path(GISDataDirectory,"PredictorRaster 250 x 250.tif")
PredictorRasterFile     <- file.path(GISDataDirectory,"PredictorRasterV4 250 x 250.tif") #upgraded after provision of Version 4 look up table
