...
#Set the output filename. If a scenario is being run, then the scenario name will be tacked on to the end of the file name
OutputBaseFileName <- "SCAMP-InputsV3Test"
if (Scenario == "Default"){
OutputFileName <- file.path(DataDirectory,paste0(OutputBaseFileName,".xlsx"))
} else {
  OutputFileName <- file.path(DataDirectory,paste0(OutputBaseFileName,"_",Scenario,".xlsx"))
}
...
if (Scenario %in% c("OurLandWater2015Potential","OurLandWater2035Potential")){
  OLWMitigationDataFile = "D:\\Projects\\LWP\\SouthlandRegionalForumModelling\\Data\\OurLandAndWaterMitigationLoads.csv"
