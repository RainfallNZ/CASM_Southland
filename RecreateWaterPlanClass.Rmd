...
write.csv(REC2WaterPlan,file.path(DataDirectory,"REC1WaterPlan.csv"))

REC2WaterPlan <- merge(SouthlandREC2[,c("nzsegment","nzreach_re")],REC2WaterPlan,by.x="nzreach_re",by.y="NZREACH",type="left")

write.csv(REC2WaterPlan[,c("nzsegment","WaterPlan")],file.path(DataDirectory,"REC2WaterPlan.csv"))
