...
######################################################################################
#This is a slight variation on a disaggregation function commonly used by LWP. I think the difference was required because I misinterpreted the IDnew parameter to the function.
#This function requires preparation of an IDSort vector, and a Reach vector.
...
# #Cut it down to Southland
# SouthlandREC2Utility <- REC1Utility[REC2Utility$Region == "S",]
# rm(REC2Utility)
